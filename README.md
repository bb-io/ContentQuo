...
- **Search evaluations** returns a list of evaluations and supports all optional API query filters, including name, PM user ID, locales, status, date filters, limit, and offset.
